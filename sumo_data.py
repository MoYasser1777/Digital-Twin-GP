...
SUMO_BINARY = "sumo-gui"  # Use "sumo" for running without GUI
CONFIG_FILE = "examples/Town04.sumocfg"  # Replace with your actual .sumocfg file
REMOTE_PORT = 8813  # Port for TraCI connection
TIME_STEP = "0.1"

# Define the vehicle ID you want to track (ensure this matches your simulation)
VEHICLE_ID = "20"  # Replace with the ID of the vehicle to track
